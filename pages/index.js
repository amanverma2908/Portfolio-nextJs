        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10 pt-2">
            ...
            <div className="text-4xl lg:gap-16 flex justify-center gap-8 py-5 text-gray-600 dark:text-gray-400">
              <a href="https://github.com/amanverma2908" target="_blank">
        ...
        <section>
          <div className="grid grid-flow-row text-2xl sm:text-md md:grid-cols-2 md:gap-4 rounded-t-lg bg-teal-400 py-8 px-4 text-center dark:bg-teal-500">
            ...
            <ul className="flex justify-center gap-6 ">
              <a href="https://github.com/amanverma2908"><AiFillGithub /></a>
              <a href="https://www.linkedin.com/in/midnightcoder"><AiFillLinkedin /></a>
              <a href="https://twitter.com/midnightcoder"><AiFillTwitterCircle /></a>
              <a href="https://medium.com/@midnightcoder"><BsMedium /></a>
            </ul>
          </div>
        </section>
      </main>
